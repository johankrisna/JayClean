            ...
            <table class="tabel-transaksi">
               <thead>
                  <tr>
                     ...
                     <th class="sticky">Jenis Layanan</th>
                     ...
                     <?php
                        ...
                        foreach($dry_clean as $dc) : ?>
                           <tr>
                              ...
                              <td><?= $dc['berat_qty_dc'] . ' Pcs' ?></td>
                              <td><?= $dc['keterangan_dc'] ?></td>
                              <td>
                                 <a href="<?=url('detail_order/detail_dc/detail_order_dc.php?or_dc_number=')?><?= $dc['or_dc_number'] ?>" class="btn btn-detail">Detail</a>
                                 <a href="<?=url('daftar_order/edit_dc.php?or_dc_number=')?><?=$dc['or_dc_number']?>" class="btn btn-edit">Edit</a>
