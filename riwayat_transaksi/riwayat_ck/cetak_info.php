...
<head>
   ...
   <link rel="shortcut icon" href="<?=url('_assets/img/logo/JayCleanBlack.png')?>" type="image/x-icon">
      ...
      <div class="invoice">
         <div class="invoice-content">
            <div class="invoice-header">
               <div class="logo">
                  <img src="<?=url('_assets/img/logo/JayCleanBlack.png')?>" width="145" alt="Logo JayClean">
               </div>
            ...
            <div class="invoice-body">
               ...
               <table class="tb_byr">
                  <tr>
                     <th class="tb_heading">Jenis layanan</th>
                     <th class="tb_heading">Jumlah</th>
                     <th class="tb_heading">Harga Per-Pcs</th>
                  </tr>
                  <tr>
                     <td><?=$data['j_paket']?></td>
                     <td><?=$data['berat'] . " Pcs"?></td>
               ...
               <div class="invoice-footer">
                  <h3 class="foot_logo"><span>Jay</span> Clean</h3>
