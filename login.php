...
<body>
	...
	<?php if (isset($_SESSION['login']) && isset($_SESSION['master'])) : ?>
		<script>window.location='http://localhost/rumah_laundry/dasboard.php'</scripwindow.location=>
	<?php endif ?> 
		...
		if (isset($_POST['login'])) {
			...
			if (mysqli_num_rows($data) > 0) {
				...
				if (password_verify($password, $hasil['password'])) {
					...
					$_SESSION['login'] = true; ?>
						<script>window.location="http://localhost/rumah_laundry/dasboard.php";</script>
				<?php 
				}else {?>
					<div class="overlay">
						<div class="boxSalah">
	...
	<div class="box">
		<div class="box-content">
			<div class="col box__left">
				<div class="logo">
					<img src="<?= url('_assets/img/logo/JayCleanBlue.png') ?>" alt="">
				</div>
			...
			<div class="col box__right">
				<div class="box__right-content">
					<div class="text__right">
						<h1>Admin JayClean</h1>
					</div>

					<img src=" <?=url('_assets/img/sepatu.png')?>" alt="" class="box-img-celana">
					<img src=" <?=url('_assets/img/sepatu2.png')?>" alt="" class="box-img-kaos">
					<img src=" <?=url('_assets/img/sepatu4.png')?>" alt="" class="box-img-kemeja">
