...
function displayFailureMessage() {
    ...
    <div class="alert">
        <div class="box">
            ...
            <button onclick="window.location='http://localhost/rumah_laundry/order/order_cs.php'" class="btn-alert">Ok</button>
        </div>
    </div>
    <?php
}
...
if (isset($_POST['order_cs'])) {
    ...
    if (!empty($_POST['no_telp_cs']) && !preg_match('/^\d{9,}$/', $_POST['no_telp_cs'])) {
