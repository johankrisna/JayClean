			...
			<div class="baris">
				<div class="selamat-datang">
					<div class="col-header">
						<h2 class="judul-md">Paket Cuci Luar</h2>
               </div>
               
					<div class="col-header txt-right">
						<a href="<?=url('paket/pkt_dc/tambah.php')?>" class="btn-lg bg-primary">+ Tambah Layanan</a>
					</div>	
				</div>
			</div>
								...
								<table class="tabel-transaksi">
									...
									<?php $no = 1; ?>
										    <?php foreach($data_dc as $dc) : ?>
												...
												<td><?= $dc['waktu_kerja_dc']. " ". $dc['durasi_dc']?></td>
												<td><?= $dc['kuantitas_dc'] . ' Pcs' ?></td>
												<td><?= $dc['tarif_dc'] ?></td>
												<td>
