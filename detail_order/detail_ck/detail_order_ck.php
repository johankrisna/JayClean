                  ...
                  <div class="card-body">
                     <form action="" method="post">
                        ...
                        <table class="tb-detail_customer">   
                           ...
                           <tr>
                              <th>Durasi Kerja</th>
                              <td><input type="text" name="waktu_kerja_ck" disabled value="<?=$data['waktu_kerja_ck']?>"></td>
                           </tr>
                        ...
                        <table class="tb-detail_order">   
                           ...
                           <tr>
                              <td><input type="text" name="berat_qty_ck" disabled value="<?=$data['berat_qty_ck'] . ' Pcs'?>"></td>
                              <td><input type="text" name="tarif_perkilo_ck" disabled value="<?= 'Rp. ' . $data['tarif_perkilo_ck']?>"></td>
                              <td><input type="text" name="total_bayar_ck" disabled value="<?= 'Rp. ' . $data['total_bayar_ck']?>"></td>
                           </tr>
                        </table>
