...
<div class="card-payment">
   ...
   <form action="" method="post">
      ...
      <input type="hidden" name="wkt_kerja" value="<?=$data['waktu_kerja_ck']?>">
      <input type="hidden" name="berat" value="<?=$data['berat_qty_ck']?>">
      <input type="hidden" name="h_perkilo" value="<?=$data['tarif_perkilo_ck']?>">
      <input type="hidden" name="tgl_msk" value="<?=$data['tgl_masuk_ck']?>">
      <input type="hidden" name="tgl_klr" value="<?=$data['tgl_keluar_ck']?>">
      <input type="hidden" name="total" value="<?=$data['total_bayar_ck']?>">
