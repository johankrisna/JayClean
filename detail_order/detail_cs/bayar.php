...
<div class="card-payment">
   ...
   <form action="" method="post">
      ...
      <input type="hidden" name="wkt_kerja" value="<?=$data['waktu_kerja_cs']?>">
      <input type="hidden" name="jml_pcs" value="<?=$data['jml_pcs']?>">
      <input type="hidden" name="h_perpcs" value="<?=$data['tarif_cs']?>">
      <input type="hidden" name="tgl_msk" value="<?=$data['tgl_masuk_cs']?>">
      <input type="hidden" name="tgl_klr" value="<?=$data['tgl_keluar_cs']?>">
      <input type="hidden" name="total" value="<?=$data['totBayar_cs']?>">
