                  ...
                  <div class="card-body">
                     <form action="" method="post">
                        ...
                        <table class="tb-detail_customer">   
                           ...
                           <tr>
                              <th>Durasi Kerja</th>
                              <td><input type="text" name="waktu_kerja_cs" disabled value="<?=$data['waktu_kerja_cs']?>"></td>
                           </tr>
                        ...
                        <table class="tb-detail_order">   
                           ...
                           <tr>
                              <td><input type="text" name="jml_pcs" disabled value="<?=$data['jml_pcs'] . ' Pcs'?>"></td>
                              <td><input type="text" name="harga_perpcs" disabled value="<?= 'Rp. ' . $data['tarif_cs']?>"></td>
                              <td><input type="text" name="tot_bayar" disabled value="<?= 'Rp. ' . $data['totBayar_cs']?>"></td>
                           </tr>
                        </table>
